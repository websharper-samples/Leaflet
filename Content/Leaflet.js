...
{
 "use strict";
 var Global,WebSharper,Leaflet,Tests,Client,Obj,UI,Var$1,Operators,HtmlModule,attr,L,Event,Var,ConcreteVar,Snap,AttrProxy,AttrModule,Doc,JavaScript,Pervasives,Client$1,Templates,Abbrev,Fresh,Attrs,DomUtility,View,Docs,EventTarget,Node,JS,Collections,Dictionary,Unchecked,SC$1,Arrays,HashSet,Seq,WindowOrWorkerGlobalScope,SC$2,SC$3,Elt,Array,DocElemNode,CharacterData,DictionaryUtil,Object,Prepare,Slice,Enumerator,KeyCollection,An,Settings,Mailbox,Updates,List,T,Attrs$1,Dyn,Strings,Docs$1,RunState,NodeSet,Anims,SC$4,SC$5,T$1,SC$6,Concurrency,AppendList,Queue,Easing,AsyncBody,SC$7,CT,HashSet$1,HashSetUtil,Scheduler,CancellationTokenSource,DomNodes,Error,OperationCanceledException,Lazy,SC$8,LazyExtensionsProxy,LazyRecord,IntelliFactory,Runtime,console,$,Date;
 Global=self;
 WebSharper=Global.WebSharper=Global.WebSharper||{};
 Leaflet=WebSharper.Leaflet=WebSharper.Leaflet||{};
 Tests=Leaflet.Tests=Leaflet.Tests||{};
 ...
 {
  var coordinates,a;
  coordinates=Var$1.Create$1("");
  a=Doc.Element("div",[],[Doc.Element("div",[AttrProxy.Create("style","height: 600px;"),AttrModule.OnAfterRender(function(div)
  {
   var map,r,m;
   function fn(map$1,ev)
   {
    return coordinates.Set("Position: "+ev.latlng.toString());
   }
   function fn$1(map$1,ev)
   {
   ...
   map.on("mouseout",function(x)
   {
    fn$1(this,x);
   });
  })],[]),Doc.Element("div",[],[Doc.TextView(coordinates.get_View())])]);
